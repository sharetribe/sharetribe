...
Before you get started, the following needs to be installed:
  ...
  * **Node**. Version 5.10.0 is currently used and we don't guarantee everything works with other versions. If you need multiple versions of Node, consider using [n](https://github.com/tj/n) or [nvm](https://github.com/creationix/nvm).
