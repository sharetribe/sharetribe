...
#Mail notifications
:new_message_in_kassi => "{{sender}} on lähettänyt sinulle viestin Kassissa",
:has_sent_you_message_in_kassi => "{{sender}} on lähettänyt sinulle Kassissa seuraavan viestin:",
:you_can_reply_to_message_in => "Voit vastata viestiin osoitteessa",
:do_not_reply_to_this_email => "Huom! Älä vastaa tähän sähköpostiviestiin, vaan käytä edellä mainittua vastauslinkkiä.",    
:your_listing_has_been_commented => "{{commenter}} on lähettänyt uuden kommentin ilmoitukseesi '{{listing}}':", 
:read_your_listing_comments_and_reply => "Voit lukea ilmoituksesi kommentit ja vastata niihin osoitteessa",
:listing_you_follow_has_been_commented => "{{commenter}} on kommentoinut seuraamaasi ilmoitusta '{{listing}}':",
:read_listing_comments_and_reply => "Voit lukea ilmoituksen kommentit ja vastata niihin osoitteessa",  
:listing_you_follow_has_been_updated => "Seuraamasi ilmoitus on päivittynyt.",
:show_listing_changes_and_comment_or_reply => "Voit nähdä muutokset osoitteessa", 
:you_have_received_feedback_about_kassi_event => "Käyttäjä {{other_party}} on antanut sinulle palautetta kassitapahtumasta.", 
:view_and_give_feedback => "Voit nähdä kassitapahtuman tiedot ja antaa palautetta käyttäjälle {{other_party}} osoitteessa", 
:someone_added_you_as_friend => "{{friend}} on lisännyt sinut kaveriksi Kassissa.",
:accept_or_reject_friend_request_at => "Voit hyväksyä tai hylätä kaverikutsun osoitteessa",
:has_nominated_you_as_realizer => "{{author}} on merkinnyt sinut ilmoituksessa {{listing}} mainitun pyynnön toteuttajaksi.",  
:show_event_and_give_feedback => "Voit nähdä kassitapahtuman tiedot ja antaa palautetta käyttäjälle {{other_party}} osoitteessa {{url}}",
:listing_from_a_friend => "{{friend}} on lähettänyt Kassiin ilmoituksen{{listing}}.",  
:show_listing_and_comment_or_reply => "Voit nähdä ilmoituksen ja vastata siihen osoitteessa {{url}}.",
:test_phrase => "Testiteksti", 

:thanks => "Terveisin,",
:kassi_team => "Kassitiimi",
:want_to_control_emails => "Mistä kaikesta haluat Kassin lähettävän sinulle sähköpostimuistutuksen?",
