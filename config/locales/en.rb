...
:give_feed_back_later => "Give feedback later",
:realizer_name_missing => "Realizer name is empty",
:no_match_with_given_name => "No person found with given name",
:cant_mark_yourself_as_realizer => "You can't mark yourself as realizer",
