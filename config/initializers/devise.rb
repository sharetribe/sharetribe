...
Devise.setup do |config|
  ...
  config.mailer_sender = APP_CONFIG.kassi_mail_from_address
  ...
  config.allow_unconfirmed_access_for = 20.years # Set unreasonably high, because we use our own check for confirmation rather than Devises. So devise always let's in, but in Kassi we check that confirmation is always needed if the community requires it.
