...
Delayed::Worker.max_run_time = APP_CONFIG.delayed_job_max_run_time.to_i.seconds # In order to recover from hanging DelayedDelta. Currently no jobs should be longer than 3min.
