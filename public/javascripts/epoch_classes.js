...
function Epoch(name,mode,targetelement,multiselect) {
	...
	*/
	function setLang() {
		self.daylist = new Array('Su','Ma','Ti','Ke','To','Pe','La','Su','Ma','Ti','Ke','To','Pe','La');
		self.months_sh = new Array('Tammi','Helmi','Maalis','Huhti','Touko','Kesä','Heinä','Elo','Syys','Loka','Marras','Joulu');
		self.monthup_title = 'Siirry seuraavaan kuukauteen';
		self.monthdn_title = 'Siirry edelliseen kuukauteen';
		self.clearbtn_caption = 'Nollaa';
		self.clearbtn_title = 'Nollaa kaikki valitut päivät kalenterista';
		self.maxrange_caption = 'Tämä on suurin arvo';
		self.closebtn_caption = 'Sulje';
		self.closebtn_title = 'Sulje kalenteri';
	}
	//-----------------------------------------------------------------------------
	/**
...
Date.prototype.dateFormat = function(format)
{
	...
	var MONTH_NAMES = new Array('Tammikuu','Helmikuu','Maaliskuu','Huhtikuu','Toukokuu','Kesäkuu','Heinäkuu','Elokuu','Syyskuu','Lokakuu','Marraskuu','Joulukuu','Tammi','Helmi','Maalis','Huhti','Touko','Kesä','Heinä','Elo','Syys','Loka','Marras','Joulu');
