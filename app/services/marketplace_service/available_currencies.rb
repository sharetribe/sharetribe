module MarketplaceService::AvailableCurrencies
  ...
  # Brazil, Czech Republic, Hungary, Israel, Italy, Japan, Mexico, Malaysia, Poland, Philippines, Russia, Singapore, Taiwan, Thailand
  COUNTRY_SET_PAYPAL_ONLY = ['BR', 'CZ', 'HU', 'IL', 'IT', 'JP', 'MX', 'MY', 'PL', 'PH', 'RU', 'SG', 'TW', 'TH']
