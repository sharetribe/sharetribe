...
function translate_validation_messages(locale) {
  ...
  jQuery.extend(jQuery.validator.messages, {
    ...
    address_validator: jQuery.validator.format(
      json.validation_messages.address_validator
    ),
    money: jQuery.validator.format(json.validation_messages.money),
    night_selected: jQuery.validator.format(
      json.validation_messages.night_selected
    ),
    availability_range: jQuery.validator.format(
      json.validation_messages.availability_range
    ),
