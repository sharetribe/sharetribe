...
window.ST.analytics.logEvent = function(category, action, opt_label) {
  $(document).trigger('st-analytics:event', {category: category, action: action, opt_label: opt_label});
}

window.ST.analytics.logout = function() {
  $(document).trigger('st-analytics:eventout');
}
