...
(function(module) {
  ...
  var updateFieldModality = function() {
    var txAgreementEnabled = $("#community_transaction_agreement_checkbox").is(
      ":checked"
    );
    var modalFields = $(
      "input.transaction-agreement-modal, textarea.transaction-agreement-modal"
    );
