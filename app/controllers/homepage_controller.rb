  ...
  def index
    ...
    if FeatureFlagHelper.search_engine == :discovery
      search_result.on_success { |listings|
        render layout: "layouts/react_page.haml", template: "search_page/search_page", locals: { bootstrapped_data: listings, notifications: NotificationsHelper.notifications(flash) }
      }.on_error {
