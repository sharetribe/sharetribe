class Admin::CommunitiesController < ApplicationController
  ...
  def settings
    ...
    if(FeatureFlagHelper.location_search_available)
      ...
      topbar_enabled_for_community = FeatureFlagService::API::Api.features.get(community_id: @current_community.id)
        .maybe[:features].or_else(Set.new).include?(:topbar_v1)

      keyword_and_location = topbar_enabled_for_community ? [:keyword_and_location] : []
