module LocationsHelper
  ...
  def get_coordinates(place_name)
    ...
    response = JSON.parse(RestClient.get("http://maps.googleapis.com/maps/api/geocode/json?address=#{escaped_place_name}&region=fi&sensor=false&bounds=#{ApplicationHelper.escape_for_url("59.5,24.5|60.5,25.5")}"))
