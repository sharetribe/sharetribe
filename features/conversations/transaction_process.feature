Feature: Transaction process between two users
  ...
  Scenario: Monetary transaction started from an offer listing
    Given there are following users:
      ...
      | kassi_testperson1 |
      | kassi_testperson2 |
    And there is item offer with title "Hammer" from "kassi_testperson1" and with share type "sell"
    And that listing requires a payment of "20"
    ...
    # TODO: Payment
    Then I should see "Mark as completed"
    And the system processes jobs
