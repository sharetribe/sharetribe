...
I want to see see all the transactions happening in my community
  ...
  Background:
    ...
    And there are following transactions
      | conversation_thread                    | listing     | status            | sum | started_at  | latest_activity | starter           | other_party       |
      | Hi! Could you help me...               | Moving help | Pending           |     | 2 days ago  | 3 hours ago     | kassi_testperson1 | kassi_testperson2 |
      | I want 2 kg of...                      | Red apples  | Paid              | $60 | 1 week ago  | 2 hours ago     | kassi_testperson2 | kassi_testperson1 |
      | This is a free message from listing... | Power drill | Free conversation |     | 2 hours ago | 1 hour ago      | kassi_testperson1 | kassi_testperson2 |
      | This is a free message from profile... |             | Free conversation |     | 13 days ago | 2 days ago      | kassi_testperson1 | kassi_testperson2 |
