...
describe SearchPageHelper do
  ...
  describe "custom field options for search" do
    ...
    it "returns ids in correct order" do
      @custom_field1 = FactoryBot.create(:custom_dropdown_field)
      @custom_field2 = FactoryBot.create(:custom_dropdown_field)
      @custom_field_option1 = FactoryBot.create(:custom_field_option, :custom_field =>  @custom_field1)
      @custom_field_option2 = FactoryBot.create(:custom_field_option, :custom_field =>  @custom_field1)
      @custom_field_option3 = FactoryBot.create(:custom_field_option, :custom_field =>  @custom_field2)
      @custom_field_option4 = FactoryBot.create(:custom_field_option, :custom_field =>  @custom_field2)
