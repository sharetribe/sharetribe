...
describe ApplicationController, type: :controller do
  ...
  describe "showing not available message" do
    ...
    it "redirects to /not_available for expired community" do
      community = FactoryGirl.create(:community)
      community.update(deleted: true)
    ...
    it "redirects to /not_available for expired community" do
      ...
      request.env[:redirect_reason] = redirect_reason
      request.env[:current_marketplace] = community
      request.env[:current_plan] = {status: :active, expired: true, closed: false}
...
describe ApplicationController, type: :controller do
  ...
  describe "showing not available message" do
    ...
    it "renders message on request to /not_available for expired community" do
      community = FactoryGirl.create(:community)
      community.update(deleted: true)
