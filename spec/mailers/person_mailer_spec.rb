...
describe PersonMailer, type: :mailer do
  ...
  describe "#transaction_confirmed" do
    ...
    it 'works with stripe payment gateway' do
      ...
      email = PersonMailer.transaction_confirmed(confirmed_transaction, community)
      expect(email.body).to have_text("Proto T has marked the order about 'Sledgehammer' completed. The money for this transaction has now been released to your bank account. You can now give feedback to Proto.")
    end
  end
end
