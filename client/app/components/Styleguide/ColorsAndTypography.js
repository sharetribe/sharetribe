...
class Colors extends Component {
  colorSwatch(color, title) {
    ...
    return div(
      { className: css.colorSwatch, style: { backgroundColor: color } },
