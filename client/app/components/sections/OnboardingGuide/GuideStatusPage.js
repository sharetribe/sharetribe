...
const GuideStatusPage = props => {
  ...
  const todoDescPartial = div([
    p(
      ...
      t("web.admin.onboarding.guide.status_page.description_p1")
    ),
    p(
      { className: css.description },
      t("web.admin.onboarding.guide.status_page.description_p2")
    )
  ]);
    ...
    p(
      ...
      t("web.admin.onboarding.guide.status_page.congratulation_p1.content", {
        knowledge_base_link: a(
          {
            href:
              "https://help.sharetribe.com/configuration-and-how-to/what-to-do-after-the-basic-setup-of-your-marketplace",
            target: "_blank",
            rel: "noreferrer",
            alt: t(
              "web.admin.onboarding.guide.status_page.congratulation_p1.knowledge_base_alt"
            )
          },
          t(
            "web.admin.onboarding.guide.status_page.congratulation_p1.knowledge_base_link"
          )
        )
      })
    ),
    p(
      ...
      t("web.admin.onboarding.guide.status_page.congratulation_p2.content", {
        marketplace_guide_link: a(
          {
            href:
              "https://www.sharetribe.com/academy/guide/?utm_source=marketplaceadminpanel&utm_medium=referral&utm_campaign=onboarding",
            target: "_blank",
            rel: "noreferrer",
            alt: t(
              "web.admin.onboarding.guide.status_page.congratulation_p2.marketplace_guide_alt"
            )
          },
          t(
            "web.admin.onboarding.guide.status_page.congratulation_p2.marketplace_guide_link"
          )
        )
      })
    ),
        ...
        contact_support_link: a(
          {
            ...
            title: t(
              "web.admin.onboarding.guide.status_page.congratulation_p3.contact_support_title"
            )
          },
          t(
            "web.admin.onboarding.guide.status_page.congratulation_p3.contact_support_link"
          )
        )
      })
    )
  ...
  const links = {
    slogan_and_description: {
      link_title:
        "web.admin.onboarding.guide.status_page.slogan_and_description",
      next_link_title:
        "web.admin.onboarding.guide.next_step.slogan_and_description",
