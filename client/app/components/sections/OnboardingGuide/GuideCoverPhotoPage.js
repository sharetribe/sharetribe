...
const GuideCoverPhotoPage = props => {
  ...
  return div({ className: "container" }, [
    ...
    h2(
      { className: css.title },
      t("web.admin.onboarding.guide.cover_photo.title")
    ),
    p(
      { className: css.description },
      t("web.admin.onboarding.guide.cover_photo.description")
    ),
    ...
    div({ className: css.infoTextContainer }, [
      ...
      div(
        ...
        [
          span(
            t("web.admin.onboarding.guide.cover_photo.advice.content1", {
              link: a(
                {
                  href:
                    "https://help.sharetribe.com/configuration-and-how-to/how-to-get-good-looking-cover-photos-logos-favicon-profiles-and-listing-pictures",
                  target: "_blank",
                  rel: "noreferrer",
              ...
              link_images: a(
                {
                  href:
                    "https://help.sharetribe.com/look-and-feel/design-and-customisation/6-great-cover-photos-ready-to-use-and-where-to-find-more",
                  target: "_blank",
                  rel: "noreferrer",
                  alt: t(
                    "web.admin.onboarding.guide.cover_photo.advice.alt_images"
                  )
                },
          ...
          br(),
          t("web.admin.onboarding.guide.cover_photo.advice.content2", {
    ...
    a(
      {
        ...
        href: routes.admin_look_and_feel_edit_path()
      },
      t("web.admin.onboarding.guide.cover_photo.add_your_own")
    )
  ]);
};
