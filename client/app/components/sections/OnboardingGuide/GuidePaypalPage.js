...
const GuidePaypalPage = props => {
  ...
  return div({ className: "container" }, [
    ...
    h2(
      { className: css.title },
      t("web.admin.onboarding.guide.payments.title")
    ),
    p(
      { className: css.description },
      t("web.admin.onboarding.guide.payments.description_p1", {
        not_sure_link: a(
          {
            href: "#",
            id: "not_sure_link",
    ...
    p(
      { className: css.description },
      t("web.admin.onboarding.guide.payments.description_p2")
    ),
    ...
    div({ className: css.infoTextContainer }, [
      ...
      div(
        ...
        t("web.admin.onboarding.guide.payments.advice.content_paypal_stripe", {
          disable_payments_link: a(
            {
              href:
                "https://help.sharetribe.com/payment-with-paypal/how-to-disable-payments-or-add-free-listings-to-your-marketplace",
              target: "_blank",
              rel: "noreferrer",
              alt: t(
                "web.admin.onboarding.guide.payments.advice.disable_payments_alt"
              )
            },
            t(
              "web.admin.onboarding.guide.payments.advice.disable_payments_link"
            )
          ),
          stripe_paypal_link: a(
            {
              href:
                "https://help.sharetribe.com/differences-between-stripe-and-paypal",
              target: "_blank",
              rel: "noreferrer",
              alt: t(
                "web.admin.onboarding.guide.payments.advice.stripe_paypal_link"
              )
            },
      ...
      a(
        {
          ...
          href: routes.admin_payment_preferences_path()
        },
        t("web.admin.onboarding.guide.payments.setup_payments")
      ),
      span(
        { className: css.buttonSeparator },
        t("web.admin.onboarding.guide.payments.cta_separator")
      ),
      a(
        {
          className: css.nextButtonGhost,
          href: routes.admin_getting_started_guide_path()
        },
        t("web.admin.onboarding.guide.next_step.skip_this_step_for_now")
      )
    ]),
    div({ className: css.disablePayments }, [
      span(
        ...
        t("web.admin.onboarding.guide.payments.i_dont_want", {
          link: a(
            { href: routes.admin_getting_started_guide_skip_payment_path() },
            t("web.admin.onboarding.guide.payments.disable_it")
          )
        })
      )
    ])
