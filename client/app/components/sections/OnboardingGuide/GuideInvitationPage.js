...
const GuideInvitationPage = props => {
  ...
  return div({ className: "container" }, [
    ...
    h2(
      { className: css.title },
      t("web.admin.onboarding.guide.invitation.title")
    ),
    p(
      { className: css.description },
      t("web.admin.onboarding.guide.invitation.description.content", {
        preview_link: a(
          {
            href: "/?big_cover_photo=true",
            alt: t(
              "web.admin.onboarding.guide.invitation.description.preview_link_alt"
            ),
            rel: "noreferrer",
            target: "_blank"
          },
    ...
    div({ className: css.infoTextContainer }, [
      ...
      div(
        ...
        t("web.admin.onboarding.guide.invitation.advice")
      )
    ]),

    a(
      { className: css.nextButton, href: routes.new_invitation_path() },
      t("web.admin.onboarding.guide.invitation.invite_users")
    )
  ]);
};
