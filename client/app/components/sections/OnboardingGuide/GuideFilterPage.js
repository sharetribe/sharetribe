  ...
  return div({ className: "container" }, [
    ...
    p({ className: css.description }, [
      t("web.admin.onboarding.guide.filter.description.content", {
        display_on_homepage: i(
          t("web.admin.onboarding.guide.filter.description.display_on_homepage")
        )
      })
    ]),
            ...
            not_too_many_link: a(
              {
                ...
                rel: "noreferrer",
                href:
                  "https://www.sharetribe.com/academy/how-to-help-your-customers-find-the-right-product-or-service/?utm_source=marketplaceadminpanel&utm_medium=referral&utm_campaign=onboardingguide"
              },
    ...
    a(
      { className: css.nextButton, href: routes.admin_custom_fields_path() },
      t("web.admin.onboarding.guide.filter.add_fields_and_filters")
    )
  ]);
};
