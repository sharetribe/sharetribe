...
const onboardingDataCompleted = onboardingData.map(d =>
...
storiesOf("Onboarding")
  .add("Guide: Status page", () =>
    div(columnWidth, withProps(GuideStatusPage, statusPageProps))
  )
  ...
  .add("Guide: Cover photo page", () =>
    div(columnWidth, withProps(GuideCoverPhotoPage, coverPhotoProps))
  )
  .add("Guide: Filter page", () =>
    div(columnWidth, withProps(GuideFilterPage, filterProps))
  )
  .add("Guide: Paypal page", () =>
    div(columnWidth, withProps(GuidePaypalPage, paymentProps))
  )
  .add("Guide: Listing page", () =>
    div(columnWidth, withProps(GuideListingPage, listingProps))
  )
  .add("Guide: Invitation page", () =>
    div(columnWidth, withProps(GuideInvitationPage, invitationProps))
  )
