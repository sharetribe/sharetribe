...
const GuideListingPage = props => {
  ...
  return div({ className: "container" }, [
    ...
    p(
      ...
      t("web.admin.onboarding.guide.listing.description")
    ),
    ...
    div({ className: css.infoTextContainer }, [
      ...
      div(
        ...
        t("web.admin.onboarding.guide.listing.advice.content", {
          close_listing: i(
            t("web.admin.onboarding.guide.listing.advice.close_listing")
          )
        })
      )
    ]),
    ...
    a(
      { className: css.nextButton, href: routes.new_listing_path() },
      t("web.admin.onboarding.guide.listing.post_your_first_listing")
    )
  ]);
};
