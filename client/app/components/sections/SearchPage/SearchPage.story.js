    ...
    listing: new ListingModel({
      ...
      author: {
        ...
        avatarImage: new AvatarImage({
          thumb: new Image({ url: "https://placehold.it/40x40" })
        }),
...
const generateListings = arrayLength => {
  const titleDraft =
    "Cisco SF300-48 SRW248G4-K9-NA 10/100 Managed Switch 48 Port";
...
storiesOf("Search results").add("Summary", () =>
  div(null, [
    h1({ className: css.title }, "Listings"),
    p(
      { className: css.description },
      "Search results are shown in grid view using listing cards. They contain square images and the result set is paged."
    ),
    ...
    h2(
      ...
      `ListingCardPanel (${LISTINGS_COUNT} listings)`
    ),
