...
const baseProps = {
  ...
  logo: {
    ...
    text: "Bikerrrs",
    image:
      "https://s3.amazonaws.com/sharetribe-manual-assets/styleguide/bikerrrs-logo.png",
    image_highres:
      "https://s3.amazonaws.com/sharetribe-manual-assets/styleguide/bikerrrs-logo.png"
  },
  search: {
...
storiesOf("Top bar")
  ...
  .add("Logged out", () => storifyTopbar(loggedOut(baseProps)))
  .add("User without profile picture", () =>
    topbarWithSpecs(
      ...
      component => {
        specs(() =>
          describe("User without profile picture", () => {
  ...
  .add("Without search", () => storifyTopbar({ ...baseProps, search: null }))
