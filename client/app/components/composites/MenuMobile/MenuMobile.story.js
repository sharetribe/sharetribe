...
const containerStyle = {
  style: { minWidth: "100px", background: "white", height: "768px" }
};

storiesOf("Top bar").add("MenuMobile: basic state", () =>
  r(
    storify(
      r(MenuMobile, {
        ...
        avatar: {
          image: new Image({
            url:
              "https://www.gravatar.com/avatar/d0865b2133d55fd507639a0fd1692b9a"
          }),
          url: "#"
        },
        newListingButton: {
