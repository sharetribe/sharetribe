...
class OffScreenMenu extends Component {
  render() {
    const headerItemHeight =
      variables["--MobileMenu_offscreenHeaderItemHeight"];

    const avatarExtras = { imageHeight: headerItemHeight };
    const buttonExtras = {
      className: css.offScreenHeaderNewListingButton,
      ...
      ? [
          this.props.avatar
            ? div(
                ...
                r(Avatar, { ...this.props.avatar, ...avatarExtras })
              )
            : null,
