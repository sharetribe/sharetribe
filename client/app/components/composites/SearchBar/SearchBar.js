...
class SearchBar extends Component {
  ...
  handleSubmit() {
    ...
    const keywordValueStr = this.keywordInput
      ? this.keywordInput.value.trim()
      : "";
    const locationValueStr = this.locationInput
  ...
  render() {
    ...
    const hasKeywordInput =
      mode === SEARCH_MODE_KEYWORD || mode === SEARCH_MODE_KEYWORD_AND_LOCATION;
    const hasLocationInput =
      mode === SEARCH_MODE_LOCATION ||
      mode === SEARCH_MODE_KEYWORD_AND_LOCATION;
        ...
        button(
          ...
          [
            ...
            span({
              ...
              style: {
                borderBottomColor: this.state.mobileSearchOpen
                  ? bgColor
                  : "transparent"
              }
            })
        ...
        form(
          {
            ...
            style: {
              backgroundColor: this.state.mobileSearchOpen
                ? bgColor
                : "transparent"
            }
          },
