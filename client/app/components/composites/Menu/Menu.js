...
class Menu extends Component {
  ...
  calculateDropdownPosition() {
    this.setState({
      // eslint-disable-line react/no-did-mount-set-state, react/no-set-state
      arrowPosition:
        this.menuLabel.offsetWidth > INITIAL_ARROW_POSITION * 2
          ? Math.floor(this.menuLabel.offsetWidth / 2)
          : INITIAL_ARROW_POSITION // eslint-disable-line no-magic-numbers
    });
  }
