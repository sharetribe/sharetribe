...
class ListingCard extends Component {
  ...
  componentDidMount() {
    ...
    if (canUseDOM && ref != null) {
      if (ref.complete) {
        ...
        this.delay(IMAGE_LOADING_TIMEOUT, IMAGE_TIMEOUT_TYPE_ERROR).then(() => {
  ...
  render() {
    ...
    const moneyFormatted = price
      ? formatMoney(price.get(":money"), localeCode)
      : null;
    const hasPricingUnit =
      price &&
      price.get(":pricingUnit") != null &&
      price.get(":pricingUnit").get(":unit") != null;
    ...
    const noListingImage = div(
      { className: classNames("ListingCard_noImage", css.noImageContainer) },
        ...
        div(
          {
            ...
            style: {
              backgroundColor: `rgb(${tintedRGB.r}, ${tintedRGB.g}, ${
                tintedRGB.b
              })`
            }
          },
        ...
        div({ className: css.info }, [
          div(
            ...
            r(Avatar, {
              ...
              image: listing.author.avatarImage
                ? listing.author.avatarImage.thumb
                : null,
              color:
                avatarColor(
                  `${listing.author.givenName}${listing.author.familyName}`
                ) || this.props.color,
            ...
            price
              ? div(
                  ...
                  [
                    div(
                      {
                        className: classNames("ListingCard_price", css.price),
                        title: price.get(":money").currency
                      },
                      moneyFormatted
                    ),
                    hasPricingUnit
              ...
              : div(
                  {
                    className: classNames(
                      "ListingCard_orderType",
                      css.orderTypeWrapper
                    ),
                    style: { color: this.props.color }
                  },
                  orderTypeLabel
