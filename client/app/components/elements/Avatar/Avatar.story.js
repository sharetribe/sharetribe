...
const containerStyle = {
  style: { background: "grey", width: "60px", height: "60px" }
};

const avatarProps = {
  image: new Image({
    url: "https://www.gravatar.com/avatar/d0865b2133d55fd507639a0fd1692b9a"
  }),
  givenName: "First",
  familyName: "Last"
};
...
storiesOf("Top bar")
  ...
  .add("Avatar without image, only given name", () => {
    ...
    const shallowed = shallow(avatar);
    specs(() =>
      describe("Avatar without image, only given name", () => {
        it("should show user initials", () => {
  ...
  .add("Avatar without image, only last name", () => {
    ...
    const shallowed = shallow(avatar);
    specs(() =>
      describe("Avatar without image, only last name", () => {
        it("should show user initials", () => {
