...
class MenuItem extends Component {
  constructor(props, context) {
    super(props, context);
    this.activeColor =
      this.props.activeColor || variables["--customColorFallback"];
    this.textColor = this.props.active
      ? variables["--MenuItem_textColorSelected"]
      : this.props.textColor || variables["--MenuItem_textColorDefault"];
  }

  render() {
    const extraClasses = this.props.extraClasses ? this.props.extraClasses : "";
    const extraClassesLink = this.props.extraClassesLink
      ? this.props.extraClassesLink
      : "";
    const inlineStyling =
      this.props.textColor != null ? { style: { color: this.textColor } } : {};
    ...
    return div({ className: `MenuItem ${css.menuitem}  ${extraClasses}` }, [
      this.props.active
        ...
        : null,
      a(linkProps, this.props.content)
    ]);
  }
}
