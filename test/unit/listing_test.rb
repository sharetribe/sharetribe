...
def test_required_attributes_not_nil
  listing_attributes_nil = Listing.new(:author_id => nil, :category => "sell", :title => nil, 
...
def test_status_validation
  #testing with all valid status
    listing_status_valid = Listing.new(:author_id => "author", :category => "sell", :title => "title", 
                                       ...
                                       :status => "nothing_yet", :language => "fi")
  ...
  #testing with invalid status
    listing_status_invalid = Listing.new(:author_id => "author", :category => "sell", :title => "title", 
                                         :content => "content", :good_thru => DateTime.now+(2), 
                                         :status => "no_status", :language => "fi")
...
def test_language_validation
  ...
  listing_language_valid = Listing.new(:author_id => "author", :category => "sell", :title => "title", 
                                     :content => "content", :good_thru => DateTime.now+(2), 
  ...
  listing_language_invalid = Listing.new(:author_id => "author", :category => "sell", :title => "title", 
                                       :content => "content", :good_thru => DateTime.now+(2), 
...
def test_length_of_title
  listing_too_long_title = Listing.new(:author_id => "author", :category => "sell", 
                                         :title => "this is a too long title for a listing as far as i know", 
                                         :content => "content", :good_thru => DateTime.now+(2), 
                                         :status => "open", :language => "fi")
  assert !listing_too_long_title.valid?
  
  
  listing_too_short_title = Listing.new(:author_id => "author", :category => "sell", 
                                         :title => "w", 
                                         :content => "content", :good_thru => DateTime.now+(2), 
                                         :status => "open", :language => "fi")
  ...
  listing_minimum_title = Listing.new(:author_id => "author", :category => "sell", 
                                         :title => "mo", 
                                         :content => "content", :good_thru => DateTime.now+(2), 
                                         :status => "open", :language => "fi")
  ...
  listing_maximum_title = Listing.new(:author_id => "author", :category => "sell", 
...
def test_length_of_value_other
  listing_too_long_value_o = Listing.new(:author_id => "author", :category => "sell", 
  ...
  listing_minimum_value_o = Listing.new(:author_id => "author", :category => "sell", 
                                         :title => "title", 
                                         :content => "content", :good_thru => DateTime.now+(2), 
                                         :status => "open", :language => "fi", 
                                         :value_other => "1")                                   
  ...
  listing_maximum_value_o = Listing.new(:author_id => "author", :category => "sell", 
                                         :title => "title", 
                                         :content => "content", :good_thru => DateTime.now+(2), 
                                         :status => "open", :language => "fi",
                                         :value_other => "asdfghjklöasdfghjklöasdfghjklöasdfghjklöasdfghjklö")
...
def test_times_viewed
  listing_times_viewed_not_int = Listing.new(:author_id => "author", :category => "sell", 
                                             :title => "title", :content => "content", 
                                             :good_thru => DateTime.now+(2), :status => "open", 
                                             :language => "fi", :times_viewed => 1.2)
  assert !listing_times_viewed_not_int.valid?
  
  listing_times_viewed_int = Listing.new(:author_id => "author", :category => "sell", 
                                             :title => "title", :content => "content", 
                                             :good_thru => DateTime.now+(2), :status => "open", 
                                             :language => "fi", :times_viewed => 1)
  assert listing_times_viewed_int.valid?
  
  listing_times_viewed_nil = Listing.new(:author_id => "author", :category => "sell", 
                                             :title => "title", :content => "content", 
                                             :good_thru => DateTime.now+(2), :status => "open", 
                                             :language => "fi", :times_viewed => nil)
  assert listing_times_viewed_nil.valid?
end

def test_value_cc
  listing_value_cc_not_int = Listing.new(:author_id => "author", :category => "sell", 
                                             :title => "title", :content => "content", 
                                             :good_thru => DateTime.now+(2), :status => "open", 
                                             :language => "fi", :value_cc => 1.2)
  assert !listing_value_cc_not_int.valid?
  
  listing_value_cc_int = Listing.new(:author_id => "author", :category => "sell", 
                                             :title => "title", :content => "content", 
                                             :good_thru => DateTime.now+(2), :status => "open", 
                                             :language => "fi", :value_cc => 1)
  assert listing_value_cc_int.valid?
  
  listing_value_cc_nil = Listing.new(:author_id => "author", :category => "sell", 
                                             :title => "title", :content => "content", 
                                             :good_thru => DateTime.now+(2), :status => "open", 
                                             :language => "fi", :value_cc => nil)
