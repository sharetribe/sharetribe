...
ActiveRecord::Schema.define(version: 20160920081409) do
  ...
  add_index "communities", ["uuid"], name: "index_communities_on_uuid", unique: true, using: :btree
  ...
  add_index "listings", ["uuid"], name: "index_listings_on_uuid", unique: true, using: :btree
