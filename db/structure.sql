...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `domain_setups_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `domain_setups_tmp` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `community_id` bigint(20) DEFAULT NULL,
  `domain` varchar(255) DEFAULT NULL,
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_domain_setups_tmp_on_community_id` (`community_id`),
  KEY `index_domain_setups_tmp_on_state_and_updated_at` (`state`,`updated_at`),
  KEY `index_domain_setups_tmp_on_critical_error` (`critical_error`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
